...
const CancelTableOrderMngt = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await axios.delete(`http://foodapp.k8s.com/api/order/${id}`, {
                headers: {
    ...
    const handleCancelOrder = async (id) => {
        setShowProgressBar(true);
        try {
            const response = await axios.put(`http://foodapp.k8s.com/api/order/${id}/5`)
            if (response.status === 200) {
    ...
    const handleUpdateStatus = async (id, status) => {
        ...
        setShowProgressBar(true);
        try {
            const response = await axios.put(`http://foodapp.k8s.com/api/order/${id}/${statusUpdate}`)
            if (response.status === 200) {
