...
const DiscountMngtHome = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await axios.get('http://foodapp.k8s.com/api/discount/all');
    ...
    const handleLockUnlock = async (params) => {
        ...
        try {
            ...
            const response = await axios.put(`http://foodapp.k8s.com/api/discount/changeStatus/${discountId}`);
    ...
    const handleDelete = async (id) => {
        setShowProgressBar(true);
        try {
            const response = await axios.delete(`http://foodapp.k8s.com/api/discount/${id}`, {
                headers: {
