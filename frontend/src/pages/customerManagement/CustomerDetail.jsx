...
const CustomerDetail = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get(`http://foodapp.k8s.com/api/account/get/${customerId}`);
        ...
        const fetchReviews = async () => {
            try {
                const response = await axios.get(`http://foodapp.k8s.com/api/review/account/${customerId}`);
    ...
    const handleDeleteReview = async (reviewId) => {
        ...
        try {
            const response = await axios.delete(`http://foodapp.k8s.com/api/review/${reviewId}`);
            if (response.status === 200) {
