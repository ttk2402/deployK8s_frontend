...
const EditStaff = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://foodapp.k8s.com/api/account/get/${staffId}`);
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                const response = await axios.put(`http://foodapp.k8s.com/api/account/${staffId}`, {
                    email: values.email,
    ...
    const handleSubmitAddAddress = async (event) => {
        ...
        try {
            const response = await axios.put(`http://foodapp.k8s.com/api/account/address/${staffId}`, address);
