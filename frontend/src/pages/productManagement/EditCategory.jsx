...
const EditCategory = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://foodapp.k8s.com/api/category/${categoryId}`);
    ...
    const handleSubmitEditCategory = async (event) => {
        ...
        try {
            const response = await axios.put(`http://foodapp.k8s.com/api/category/${categoryId}`, category);
